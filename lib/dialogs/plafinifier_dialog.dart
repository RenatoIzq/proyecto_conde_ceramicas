...
class DialogPlanificar extends StatefulWidget {
  final DateTime fechaSeleccionada;
  final Function(Hornada) onPlanificar;

  const DialogPlanificar({
    Key? key,
  ...
  @override
  State<DialogPlanificar> createState() => _DialogPlanificarState();
}

class _DialogPlanificarState extends State<DialogPlanificar> {
